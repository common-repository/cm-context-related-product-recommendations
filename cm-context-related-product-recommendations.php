...
{
    define('CMCRPR_RELEASE_NOTES', 'https://www.cminds.com/wordpress-plugins-library/custom-product-recommendations-for-wordpress#changelog');
}
...
{
    define('CMCRPR_WORDPRESS_URL', 'https://www.cminds.com/wordpress-plugins-library/custom-product-recommendations-for-wordpress/');
}
...
{
    define('CMCRPR_WORDPRESS_REVIEW_URL', 'https://www.cminds.com/wordpress-plugins-library/custom-product-recommendations-for-wordpress/');
}
...
{
    define('CMCRPR_SHOP_URL', 'https://www.cminds.com/wordpress-plugins-library/custom-product-recommendations-for-wordpress/');
}
